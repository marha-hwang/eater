...
class ReviewsOfResAdapter(val context: Context) :
    RecyclerView.Adapter<ReviewsOfResAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(private val binding: ItemReviewBinding) :
        ...
        fun bind(ID: String, title: String, content: String, date: String) {
            ...
            binding.cardView.setOnClickListener {
                ...
                val action =
                    reviewsOfRestaurantFragmentDirections.actionReviewsOfRestaurantFragmentToDetailReviewFragment(
                        ID
                    )
                nav?.navigate(action)
                Log.d("id", "id= " + ID)
